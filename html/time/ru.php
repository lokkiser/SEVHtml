...
<title>Установка сдвига времени offset</title>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-header p-5 pb-4 border-bottom-0">
              <h1 class="fw-bold mb-0 fs-4">Установка сдвига времени offset</h1>
            </div>
            ...
            <div class="modal-body p-5 pt-0">
              ...
              <form method="POST">
                ...
                <br><br>
                <small class="text-body-secondary">Установка сдвига времени относительно данных внешних приёмников в + или -, Внимание! Время обновления времени 15 секунд на сервере времени с момента нажатия кнопки сохранить и далее в зависимости. </small>
              </form>
            </div>
          </div>
        </div>
